...
## Session Logs
Latest work session notes live under `docs/SESSION-YYYY-MM-DD.md` (most recent: `docs/SESSION-2025-11-20.md`). Older entries have been archived under `docs/archive/` (e.g., `docs/archive/2025-09/`). Check the latest entry before resuming a thread.

...
const productDatabase = {
  ...
  "burzum-hvis-lyset": {
    ...
    images: ["/src/assets/album-2.jpg", "/src/assets/album-1.jpg"],
  ...
  "emperor-nightside": {
    ...
    images: ["/src/assets/album-3.jpg", "/src/assets/album-4.jpg"],
  ...
  "darkthrone-transilvanian": {
    ...
    format: "Vinyl",
    price: 42.00,
    image: "/src/assets/album-4.jpg",
    images: ["/src/assets/album-4.jpg", "/src/assets/album-5.jpg"],
  ...
  "dissection-somberlain": {
    ...
    price: 48.00,
    originalPrice: 55.00,
    image: "/src/assets/album-5.jpg",
    images: ["/src/assets/album-5.jpg", "/src/assets/album-6.jpg"],
  ...
  "darkthrone-funeral-moon": {
    ...
    format: "Cassette",
    price: 22.00,
    image: "/src/assets/album-6.jpg",
    images: ["/src/assets/album-6.jpg", "/src/assets/album-1.jpg"],
  ...
  "rec-2": {
    ...
    price: 18.99,
    image: "/src/assets/album-2.jpg",
    images: ["/src/assets/album-2.jpg", "/src/assets/album-3.jpg"],

        ...
        <div style="background: #1a1a1a; color: #f5f5f5; font-family: 'Cinzel', serif; padding: 20px;">
          <div style="max-width: 600px; margin: 0 auto;">
            <div style="text-align: center; margin-bottom: 30px;">
              <h1 style="color: #dc2626; font-size: 32px; margin: 0;">⚔️ Black Plague Records</h1>
            ...
            <div style="text-align: center; margin-top: 30px;">
              ...
              <p style="color: #9ca3af; font-size: 14px;">— The Black Plague Records Cult</p>
            </div>
          </div>
        </div>
      `
    ...
    shipping_update: {
      ...
      content: `
        <div style="background: #1a1a1a; color: #f5f5f5; font-family: 'Cinzel', serif; padding: 20px;">
          <div style="max-width: 600px; margin: 0 auto;">
            <div style="text-align: center; margin-bottom: 30px;">
              <h1 style="color: #dc2626; font-size: 32px; margin: 0;">🚚 Black Plague Records</h1>
